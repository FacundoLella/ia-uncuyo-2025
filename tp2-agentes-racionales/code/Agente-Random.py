...
class ExampleAgent(BaseAgent):
    ...
    def __init__(self, server_url: str = "http://localhost:5000", 
        ...
        self.movement_sequence = [self.up, self.right, self.down, self.left,self.suck,self.idle]
        self.current_move_index = random.randint(0,3)
