...
# ---------------------------------------------------------
# a) Función para crear los folds aleatorios
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# b) Función principal de Validación Cruzada
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# c) Ejecución del script principal
# ---------------------------------------------------------
...
mi_df <- mi_df %>% select(-ultima_modificacion)

# Agrupar especies con baja frecuencia
mi_df <- mi_df %>%
  mutate(
...
# Guardar resultados
write.csv(resultados_cv$media, "resultados_cv_media.csv", row.names = TRUE)
write.csv(resultados_cv$desviacion_estandar, "resultados_cv_desvest.csv", row.names = TRUE)

cat("\n✅ Archivos guardados: resultados_cv_media.csv y resultados_cv_desvest.csv\n")
